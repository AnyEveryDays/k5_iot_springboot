...
// FK 설정은 무조건 ManyToOne 설정해야함
// OneToMany는 필수는 아닌데 특수한 상황에선 해야함
...
public class I_OrderItem extends BaseTimeEntity {
    ...
    @JoinColumn(name = "order_id", nullable = false,
            foreignKey = @ForeignKey(name = "idx_order_items_order"))
    ...
    @JoinColumn(name = "product_id", nullable = false,
            foreignKey = @ForeignKey(name = "idx_order_items_product"))
